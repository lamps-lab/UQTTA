    ...
    def get_bboxes(self,
        ...
        if cfg is None:
            ...
            if proposal_list is not None:
                det_bboxes, det_labels, proposal_score = multiclass_nms(bboxes, scores,
                                                                        cfg.score_thr, cfg.nms,
                                                                        cfg.max_per_img, proposal_list=proposal_list)
                return det_bboxes, det_labels, proposal_score
            else:
                det_bboxes, det_labels, proposal_score = multiclass_nms(bboxes, scores,
                                                                        cfg.score_thr, cfg.nms,
                                                                        cfg.max_per_img)
